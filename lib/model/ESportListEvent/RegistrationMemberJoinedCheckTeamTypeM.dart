class RegistrationMemberJoinedCheckTeamTypeM {
  List<Members> members;
  TeamId teamId;
  bool isWinner;
  bool winningCredited;

  RegistrationMemberJoinedCheckTeamTypeM(
      {this.members, this.teamId, this.isWinner, this.winningCredited});

  RegistrationMemberJoinedCheckTeamTypeM.fromJson(Map<String, dynamic> json) {
