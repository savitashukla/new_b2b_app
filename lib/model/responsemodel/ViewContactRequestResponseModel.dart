...
class ViewContactRequestResponseModel extends AppBaseResponseModel {
  List<Data> data;
  ViewContactRequestResponseModel(
      { this.data});

  ViewContactRequestResponseModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    error = json['error'];
    if (json['data'] != null) {
      data = new List<Data>();
 ...
 class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    vendorDiscription = json['vendor_discription']==null?"":json['vendor_discription'];
    isShowContact = json['is_show_contact'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['vendor_discription'] = this.vendorDiscription;
    data['is_show_contact'] = this.isShowContact;
...
class User {
  ...
  User.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    zoneId = json['zone_id'].cast<String>();
    name = json['name'];
    lname = json['lname'];
