...
class PokerHowToPlayWebview extends StatefulWidget {
  String url;

  PokerHowToPlayWebview(this.url);

  @override
  PokerHowToPlayWebviewState createState() => PokerHowToPlayWebviewState(url);
}

class PokerHowToPlayWebviewState extends State<PokerHowToPlayWebview> {
  String url;

  PokerHowToPlayWebviewState(String url) {
    this.url = url;
  }
          ...
          body: Container(
            ...
            navigationDelegate: (NavigationRequest request) async {
              ...
              if (request.url.contains("https://docs.google.com/forms/d/e/")) {
                await launch("https://docs.google.com/forms/d/e/1FAIpQLSf4hwRTYCjymSAzSYpGwFxKglPe9IwqIzTc5aJldgxMg7HpWg/viewform");
