...
import 'GameZop_Details_Controller.dart';

class UnityDetails extends StatelessWidget {
  String _url;
  ...
  UnityDetails(this._url, this.history_list, this.pos);

  Unity_Details_Controller base_controller =
      Get.put(Unity_Details_Controller());
