...
class Match_Making_Screen extends StatefulWidget {
  String event_id;
  String gameid;
  String mapV;
  String playAmount;
  ...
  @override
  State<Match_Making_Screen> createState() =>
      _Match_Making_ScreenState(event_id, gameid, mapV, playAmount, url1);
}

class _Match_Making_ScreenState extends State<Match_Making_Screen>
...
/*  Match_Making_Screen_Controller match_Making_Screen_Controlleer =
  ...
  Future<Map> getPreJoinEventGameZob(String event_id) async {
    ...
    final param = {
      ...
      "thirdParty": {"type": "gameZop", "gameCode": "hgempP8Sc"}
    };
  ...
  Future<Map> getPreJoinEventGameZobClick(String event_id) async {
  ...
  Future<void> getUnityHistoryOnly(String game_id) async {
    ...
    if (response != null) {
      ...
      try {
        //Fluttertoast.showToast(msg: 'Test GameZop:: 2');
        //print('Test GameZop:: 2');
        ...
        //double depositeBalnaceSum = total;
        //print('Test GameZop:: 2 ${total}');
