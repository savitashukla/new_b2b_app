...
import 'GameZopController.dart';
import 'GameZopDetails.dart';
import 'GameZopWebview.dart';

class GameJobList extends StatefulWidget {
  var gameid1;
  String url1;
  String name1 = "";

  GameJobList(this.gameid1, this.url1, this.name1);

  GameJobListS createState() => GameJobListS(gameid1, url1, name1);
}

class GameJobListS extends State<GameJobList> with WidgetsBindingObserver {
  var gameid;
  String url;
  String name = "";
  ...
  Widget build(BuildContext context) {
    controller = Get.put(GameZobController(gameid));
                    ...
                    ClipRRect(
                      ...
                      child: url != null && url.isNotEmpty
                          ...
                          : Image(
                              ...
                              width: 35,
                              fit: BoxFit.cover,
                              image: AssetImage('assets/images/quick_ludo.png'),
                            ),
                    ),
                    Padding(
...
/*    Future.delayed(const Duration(seconds: 3), () async {
    ...
    if (response != null && response['statusCode'] == null) {
      ...
      if (preJoinResponseModel != null) {
        ...
        if (deficitAmount.value > 0) {
          ...
          Utils()
              .customPrint('contestAmount gamezop ${AppString.contestAmount}');
                          ...
                          Obx(() => GestureDetector(
                                onTap: () {
                                  if (walletPageController
                                    ...
                                    getPreJoinEventGameZobGameContestLootbox(
                                        controller.unityEventList.value
                                            .data[index].id,
                                        context,
                                        controller
  ...
  Future<Map> getPreJoinEventGameZobGameContestLootbox(
      String event_id, BuildContext context, int amount) async {
    //print("event_id ===>${contest_id}");
    Utils().customPrint("user_id ===> ${controller.user_id}");
    final param = {
